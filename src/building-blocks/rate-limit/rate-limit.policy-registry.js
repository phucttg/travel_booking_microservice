...
exports.getRateLimitPolicyById = exports.resolveRateLimitPolicy = exports.shouldBypassRateLimit = exports.resolveRequestRoutePath = void 0;
const dim = (id, keyType, limit, windowSeconds, fallbackToIp = false) => ({
    id,
    keyType,
    limit,
    windowSeconds,
...
const resolveRequestRoutePath = (request) => {
...
exports.resolveRequestRoutePath = resolveRequestRoutePath;
const shouldBypassRateLimit = (routePath) => {
...
exports.resolveRateLimitPolicy = resolveRateLimitPolicy;
const getRateLimitPolicyById = (policyId) => {
    return policies[policyId] ?? null;
};
exports.getRateLimitPolicyById = getRateLimitPolicyById;
//# sourceMappingURL=rate-limit.policy-registry.js.map